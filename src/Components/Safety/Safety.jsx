...
import abtUs from "../../img/Safety.jpg";
import "./safety.css";
// import Coro from "./Carousel/Carousel"
import AOS from "aos";
    ...
    <div className="">
      ...
      >
        <div className="container" data-aos="fade-right">
          <div className="row">
            <h2 className="abtComTitle">Safety Features</h2>
          </div>
          <div className="row ">
            <div className="col-4">
              <img
            ...
            <div className="col-8">
              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <span>
                    ...
                    relief valve. Also, we have installed a BS & B make rupture
                    disk on each reactors. Utilities, such as cooling tower,
                    water jet ejectors on a separate structure providing clear
                    and open space for material movement, are installed{" "}
                  </span>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-md-10">
                  <span>
                    Flame proof electric fittings. A centralised electronic
                    panel controls all equipment from single place. Whole plant
                    has been provided with proper earthing, deep pipe have been
                    installed in reactors and receivers and drums filling is
                    also done with proper earthing
                  </span>
                </div>
              </div>
              <div className="row">
              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <span>
                    {" "}
                    Auto temperature controllers are provided for all the
                    reactors. Vacuum braking is done with nitrogen{" "}
                  </span>
                </div>
              </div>
              <div className="row">
          ...
          <div className="col-8 ">
            ...
            <div className="row ml-1">
              <span>
                ...
                response.
                <br />
                <br /> M.S.D.S. (Material Safety Data Sheet) of all products in
                the premises is available with the laboratory department and
                security cabin.
              </span>
            </div>
          </div>
